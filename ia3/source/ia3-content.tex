...
Für \ialoudspeaker{»unwahrscheinlich«} hielt der Quantencomputer diese Vorstellung. \ialoudspeaker{»Es handelt sich zwar strenggenommen um eine aktive Ortungsform, aber das Ziel empfängt höchstens einen Bruchteil der Energie. Fast die gesamte Strahlung fliegt verzerrt an der Däns Miräköl vorbei und verebbt nach einigen Lichtjahren. Die Flugvektoren unterscheiden sich so geringfügig, dass kein messbarer Warp-Lock auftritt.«}
